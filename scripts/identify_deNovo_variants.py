...
if inputMaf != "None":
    ...
    outputFile = f"{pathToFiles}/{diseaseName}_deNovo_cadd{inputCaddStr}_maf{inputMafStr}.tsv"
else:
    outputFile = f"{pathToFiles}/{diseaseName}_deNovo_cadd{inputCaddStr}.tsv"
...
a dictionary where the key is a gene and the value is a list of genotypes (or positions) where deNovo variant(s) are found.
"""
deNovoPositionDict = {}
deNovoGenotypeDict = {}
for patient in patientList:
    ...
    for gene, genotypes in sampleGenotype[patient].items():
        for i, genotype in enumerate(genotypes):
            ...
            #This part helps eliminate genotypes being added to the deNovo list where either parent has a variant
            parentGenotype1 = ""
            parentGenotype2 = ""
